...
import { bookTicket } from "../../../redux/actions/BookingTicketManagementAction";
...
export default function PayMent() {
  ...
  const handleBookTicket = () => {
    ...
    if (
      ...
      dispatch(bookTicket({ maLichChieu, danhSachVe, taiKhoan }));
      // dispatch(bookTicket({ maLichChieu: 40396, danhSachVe: [{ maGhe: 9122569, giaVe: 75000 }], taiKhoan }))
    }
  };
  const onFocus = (e) => {
    ...
    <aside className={classes.payMent}>
          ...
          <div className={classes.formPayment}>
            <div className={classes.formPaymentItem}>
              ...
              <img
                ...
                src="/assets/img/bookticket/zalo.jpg"
                alt="zalopay"
              />
            ...
            <div className={classes.formPaymentItem}>
              ...
              <img
                className={classes.img}
                src="/assets/img/bookticket/visa.png"
                alt="visa"
              />
            ...
            <div className={classes.formPaymentItem}>
              ...
              <img
                className={classes.img}
                src="/assets/img/bookticket/atm.png"
                alt="atm"
              />
            ...
            <div className={classes.formPaymentItem}>
              ...
              <img
                className={classes.img}
                src="/assets/img/bookticket/cuahang.png"
                alt="cuahang"
              />
      ...
      <div className={classes.notice}>
        <img
          ...
          src="/assets/img/bookticket/exclamation.png"
          alt="notice"
        />
